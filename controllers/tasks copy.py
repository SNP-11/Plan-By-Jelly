...
class TaskController:
    ...
    def add_task(self, uid, label, start_time, end_time):
        ...
        new_task = Tasks(uid=uid, label=label, start_time=start_time, end_time=end_time)
    ...
    def get_tasks_by_uid(self, uid):
        ...
        for task in fetched_tasks:
            print(f"Task ID: {task.id}, Start Time: {task.start_time}, End Time: {task.end_time}")
